...
use App\Core\Acl\Exceptions\PermissionNotFoundException; 
use App\Models\Acl\Permission as ModelsPermission;
...
trait HasPermissions
{
    ...
    public function permissions(): BelongsToMany
    {
        ...
        return $this->belongsToMany(config('acl.models.permission', ModelsPermission::class))->withTimestamps();
    }
     ...
     *
     * @return \App\Contracts\IPermission|\Illuminate\Database\Eloquent\Collection
     */
    protected function getPermissionModel()
    {
        ...
        return app()->make(config('acl.models.permission', ModelsPermission::class));
    }
}
